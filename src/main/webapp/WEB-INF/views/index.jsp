...
<%session.invalidate(); %>
  ...
  <div class="modal fade" id="description-google" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <p>A personal, non-profit/non-commercial and open/crowd source website, where all the services are implemented to make a proof of concept for new learnings </p>
  </div>
